...
from store_site import settings
...
class TestUserManagement(TestCase):
    def setUp(self):
        ...
        self.superuser = ShopUser.objects.create_superuser('django2', 'django2@shop.local', 'geek')

        self.user = ShopUser.objects.create_user('tarantino', 'tarantino@shop.local', 'geek')
    ...
    def test_user_login(self):
        ...
        # данные пользователя
        self.client.login(username='tarantino', password='geek')
        ...
        def test_user_register(self):
            ...
            new_user_data = {
                ...
                'first_name': 'Сэмюэл',
                'last_name': 'Джексон',
                'password1': 'geek123QWE',
                'password2': 'geek123QWE',
